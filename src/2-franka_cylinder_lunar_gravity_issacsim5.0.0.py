"""
Franka Robot - Move Cylinder from Left to Right (with RMPflow)
================================================================
A standalone script using RMPflow for smooth inverse kinematics control.
The robot will smoothly move a cylinder from its left side to right side.
...
Usage:
    Linux:   ~/isaacsim/python.sh franka_rmpflow_moon.py
    Windows: C:\isaacsim\python.bat franka_rmpflow_moon.py
"""
